      ...
      {data.map((post)=>{
        ...
        return (<> 
          ...
          <div className='options' >
            ...
            {he.options2 && <Link to="/Ques"><button className='bn31' onClick={()=>{props.setno(props.no+1)}}><span class="bn31span">{he.options2}</span></button><br/><br/></Link>}
            ...
            {he.options3 && <Link to="/SCS"><button className='bn31'><span class="bn31span">{he.options3}</span></button><br/><br/></Link>} 
          </div>
          </> } 
          </>    
          )
